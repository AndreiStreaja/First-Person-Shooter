...
public class FPController : MonoBehaviour
{
    ...
    public navigationController compassC;
    ...
    public void TakeHit(float amount)
    {
        ...
        bloodSplatter.transform.position = new Vector3(UnityEngine.Random.Range(0, cWidth), UnityEngine.Random.Range(0, cHeight), 0);
        Destroy(bloodSplatter, 2.2f);
        float bloodScale = UnityEngine.Random.Range(0.3f, 1.5f);
        ...
        if (health <= 0)
        {
            ...
            {
                steve.GetComponent<script>().enabled = false;
                cam.SetActive(false);
                Invoke("Respawn", 5);
            }
            deathSound.Play();
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            GameObject gameOver1 = Instantiate(gameOver);
            gameOver1.transform.SetParent(canvas.transform);
            gameOver1.transform.position = new Vector3(1920f / 2f, 1080f / 1.28f, 0f);


            Vector3 pos1 = new Vector3(this.transform.position.x,
                          Terrain.activeTerrain.SampleHeight(this.transform.position),
                          this.transform.position.z);
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.LeftShift)) 
        {
            ...
            transform.position += (rb.transform.forward * z + cam.transform.right * x) * runningSpeed;
        }
    ...
    void FixedUpdate()
    {
        ...
        transform.position += rb.transform.forward * z + cam.transform.right * x; //new Vector3(x * speed, 0, z * speed);
